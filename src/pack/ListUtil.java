...
public class ListUtil {
	...
	/**
	 * Sort the elements in array.Then searches for an element in an array.Use binary search
	 * which searches a sorted array by repeatedly dividing the search interval in half. 
	 * If the value of the search key is less than the element in the middle of the interval, 
